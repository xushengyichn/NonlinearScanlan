...
% 求解安装TMD后的响应
function [Mode]=Damping_n_modes(mu,zetaTMD,fTMD,locationTMD,calmodes)
% mu TMD质量比
% zetaTMD TMD阻尼比
% fTMD TMD频率
% locationTMD TMD位置
...
ifcalmode = 3;
nodeTMD=locationTMD;
[Mode]=CalDamping_Polynomial_withTMD_multidegree(nTMD,mTMD,zetaTMD,omegaTMD,nodeTMD,mode_number,ifcalmode,MM_eq,KK_eq,calmodes,eig_val,eig_vec);
