...
zetaTMD = optimvar('zetaTMD',nTMD, 'LowerBound', 0.05, 'UpperBound', 0.1);
omegaTMD = optimvar('omegaTMD', nTMD,'LowerBound', 0.8 * 2 * pi, 'UpperBound', 1.2 * 2 * pi);
nodeTMD = optimvar('nodeTMD', nTMD,'Type', 'integer', 'LowerBound', 1001, 'UpperBound', 1406);
...
x0.zetaTMD = 0.05*ones(nTMD,1);
x0.omegaTMD = 0.8 * 2 * pi*ones(nTMD,1);
x0.nodeTMD = 1001*ones(nTMD,1);
