...
gfun2 = @(u,udot) bridge_damper(u,udot,U,D,b_lower,0,0,0,0,MM,CC,KK,mode_integral_2,mode_integral_3,mode_integral_4,mode_integral_5,mode_integral_6,gamma,beta,h,matrixsize,mode_number); % Handle to the nonlinear function
gfun3 = @(u,udot) bridge_damper(u,udot,U,D,b_upper,0,0,0,0,MM,CC,KK,mode_integral_2,mode_integral_3,mode_integral_4,mode_integral_5,mode_integral_6,gamma,beta,h,matrixsize,mode_number); % Handle to the nonlinear function
% TODO: 还没有考虑气动刚度
...
% [u, udot, u2dot] = nonlinear_newmark_krenk(gfun1,gfun2,gfun3, MM, pp, u0, udot0, gamma, beta, h,upperlimit,lowerlimit,F0); % Solve the response by the Nonlinear Newmark algorithm
