...
P2=fangdaxishu*zhenxing1*sin(THETA*t);
...
figure()
plot(t,Dis,'b')
xlabel('Time [s]'); ylabel("displacement of the mid-span"); 
title("Comparison of the calculated displacement")
hold on
plot(t(1:round(end*0.9,0)),u(99,1:round(end*0.9,0)),'r')
legend("Superposition method(0.01 second)","Direct integration(1.26 second)")
% 
% close all
% 
