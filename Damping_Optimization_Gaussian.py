...
LastEditTime: 2022-11-12 20:39:07
FilePath: \NonlinearScanlan\Damping_Optimization_Gaussian.py
...
def black_box_function(mTMD1,mTMD2,zetaTMD1,zetaTMD2,zetaTMD3,fTMD1,fTMD2,fTMD3,xTMD1,xTMD2,xTMD3):
    ...
    xTMD2=xTMD2*660
    xTMD3=xTMD3*660
    zetaTMD1=zetaTMD1*0.2+0.05
    zetaTMD2=zetaTMD2*0.2+0.05
    zetaTMD3=zetaTMD3*0.2+0.05
    mTMD1=mass_six_span*0.014*mTMD1+mass_six_span*0.001
    mTMD2=mass_six_span*0.014*mTMD2+mass_six_span*0.001
    mode_numbers=3.
    numberofTMD=3.
    calmodes_all=3.
    mu=0.02
...
optimizer = BayesianOptimization(
    ...
    pbounds={"mTMD1": (0, 1), "mTMD2": (0, 1),"zetaTMD1": (0, 1),"zetaTMD2": (0, 1),"zetaTMD3": (0, 1),"fTMD1": (0, 1),"fTMD2": (0, 1),"fTMD3": (0, 1),"xTMD1": (0, 1),"xTMD2": (0, 1),"xTMD3": (0, 1)},
...
optimizer.maximize(
    ...
    n_iter=1000,
    acq="ucb", 
    kappa=5.030456216271596,
    # What follows are GP regressor parameters
    kernel=Matern(nu=2.5),
    alpha=1.8769582559077192e-10,
    # alpha=1e-5,
    normalize_y=True,
