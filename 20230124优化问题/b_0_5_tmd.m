...
%LastEditTime: 2023-02-03 23:56:25
%FilePath: \NonlinearScanlan\20230124优化问题\b_0_5_tmd.m
...
function [result] = b_0_5_tmd(number_of_modes_to_control,number_of_modes_to_consider,number_of_tmds,modal_damping_ratios,t_length,mTMD1,mTMD2,mTMD3,mTMD4,fTMD1,fTMD2,fTMD3,fTMD4,fTMD5,dTMD1,dTMD2,dTMD3,dTMD4,dTMD5,xTMD1,xTMD2,xTMD3,xTMD4,xTMD5,total_tmd_mass)
...
%     xTMD3=xTMD3*660 % TMD3的x坐标 The x-coordinate of TMD3
    ...
    mTMD5=total_tmd_mass-mTMD1-mTMD2-mTMD3-mTMD4; % 质量 The mass mTMD6;
    TMDs_mass=[mTMD1,mTMD2,mTMD3,mTMD4,mTMD5];
    TMDs_frequency=[fTMD1,fTMD2,fTMD3,fTMD4,fTMD5];
    TMDs_damping_ratio=[dTMD1,dTMD2,dTMD3,dTMD4,dTMD5];
    TMDs_location=[xTMD1,xTMD2,xTMD3,xTMD4,xTMD5];
