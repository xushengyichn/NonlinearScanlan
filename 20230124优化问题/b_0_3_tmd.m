...
function [result] = b_0_3_tmd(number_of_modes_to_control,number_of_modes_to_consider,number_of_tmds,modal_damping_ratios,t_length,mTMD1,mTMD2,fTMD1,fTMD2,fTMD3,dTMD1,dTMD2,dTMD3,xTMD1,xTMD2,xTMD3,total_tmd_mass)
...
%     xTMD3=xTMD3*660 % TMD3的x坐标 The x-coordinate of TMD3
    ...
    mTMD3=total_tmd_mass-mTMD1-mTMD2;
    TMDs_mass=[mTMD1,mTMD2,mTMD3];
    TMDs_frequency=[fTMD1,fTMD2,fTMD3];
    TMDs_damping_ratio=[dTMD1,dTMD2,dTMD3];
    TMDs_location=[xTMD1,xTMD2,xTMD3];
